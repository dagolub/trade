...
import { updateWallet, createWallet } from "../../services/api"; // Make sure to provide the correct path to updateWallet
...
function Form({ wallet = "", type = "", id = "" }) {
    ...
    return (
        <div className="max-w-sm mx-auto w-full px-4 py-8">
            <h1 className="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">Creating Wallet</h1>
