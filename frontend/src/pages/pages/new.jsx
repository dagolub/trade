...
function PagesNew() {
    ...
    const submitHandler = (e) => {
        ...
        if (loading === false) {
            setLoading(true)
            createPage(refTitle.current.value,
            ...
            <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                ...
                <main className="grow">
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                        <h1 className="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">New page</h1>
                        <form method="POST" onSubmit={submitHandler}>
                            ...
                            <div>
                                <div>
                                    ...
                                    <input id="supporting-text" className="form-input w-full" type="text" ref={refTitle}
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium mb-1" htmlFor="supporting-text">
