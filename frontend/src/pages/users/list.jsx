...
function UsersList() {
    ...
    const settingList = () => {
        getEntities(getUsers, setList)
    };

    React.useEffect(() => {
        settingList()
        setTot('users', setTotal)
    }, []);
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                        <div className="sm:flex sm:justify-between sm:items-center mb-5">
                            <div className="mb-4 sm:mb-0">
                                <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Users
                                    ✨</h1>
                            </div>
                            <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                                <SearchForm placeholder="Search by Full Name"/>
                                <a href="/users/new">
                        ...
                        <UsersTable list={list} settingList={settingList}/>
                        <div className="mt-8">
