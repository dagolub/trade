...
function Folders() {
  ...
  const [total, setTotal] = React.useState(0);
    ...
    const settingList = () => {
        getEntities(getFolders, setList)
    };

    React.useEffect(() => {
        settingList()
        setTot('folders', setTotal)
    }, []);
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="sm:flex sm:justify-between sm:items-center mb-5">
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Folders ✨</h1>
              </div>
            ...
            <FoldersTable list={list} settingList={settingList} />
            <div className="mt-8">
